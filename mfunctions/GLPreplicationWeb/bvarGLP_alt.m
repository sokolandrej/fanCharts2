function r = bvarGLP_alt(y,lags,varargin)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[~,xh,~,~,itct,~,~] = csminwel('logMLVAR_formin',x0,H0,[],1e-6,10000,y,x,lags,T,n,b,MIN,MAX,SS,Vc,pos,mn,sur,noc,y0,hyperpriors,priorcoef);
...
%     HH=real(V*abs(E)*V'); %added real
    ...
    fun = @(par) logMLVAR_formcmc(par,y,x,lags,T,n,b,MIN,MAX,SS,Vc,pos,mn,sur,noc,y0,0,hyperpriors,priorcoef);%,Tcovid);
...
%     cholHess = const*chol(HH,'lower');
    ...
    while logMLold==-10e15
        ...
        [logMLold,~,~]=logMLVAR_formcmc(P(:,1),y,x,lags,T,n,b,MIN,MAX,SS,Vc,pos,mn,sur,noc,y0,...
